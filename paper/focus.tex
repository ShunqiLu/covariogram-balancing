...
\begin{figure}[ht]
  ...
  \caption{Logical architecture.  Above: a centered exchange fiber, the
  atomic exposure $\varepsilon\in\{0,1\}$ of one balancing transfer, and the
  fixed-shell Schur order their sum produces, together with a fiberwise
  equality certificate.  Below: the quantitative layer, which is
  body-dependent.  The structural theorem of Section~\ref{sec:structural}
